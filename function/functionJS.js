module.exports = {
    ...
    async QuestionReponce(MessageOrInteraction, text, client) {
        const id = MessageOrInteraction.user ? MessageOrInteraction.user.id : MessageOrInteraction.author.id
        ...
        const reponce = (await MessageOrInteraction.channel.awaitMessages({
            filter: filterMessage, max: 1, time: 30000
        })).first()
